...
public protocol SlidingButtonDelegate: class {
  func slideToOpenDelegateDidFinish(_ sender: SlidingButton)
}

open class SlidingButton: UIView {

  public weak var delegate: SlidingButtonDelegate?
  ...
  private func updateThumbnailXPosition(_ constant: CGFloat) {
    leadingThumbnailViewConstraint?.constant = constant
    setNeedsLayout()
  }
